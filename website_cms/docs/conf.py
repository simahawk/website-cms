# -*- coding: utf-8 -*-
#
# Website CMS documentation build configuration file, created by
...
project = u'Website CMS'
copyright = u'2016, Camptocamp SA'
author = u'Camptocamp SA'
...
#
# html_title = u'Website CMS v1.0.1'
...
htmlhelp_basename = 'WebsiteCMSdoc'
...
latex_documents = [
    (master_doc, 'WebsiteCMS.tex', u'Website CMS Documentation',
...
man_pages = [
    (master_doc, 'websitecms', u'Website CMS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'WebsiteCMS', u'Website CMS Documentation',
     author, 'WebsiteCMS', 'One line description of project.',
     'Miscellaneous'),
]
